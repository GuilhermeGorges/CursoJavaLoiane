...
public class Aula94DiferencaEntreDatas {
    ...
    public static void diferencaDataAteJava7() throws ParseException {
        ...
        Date primeiraDt = sdf.parse("01/01/2021");
        Date segundaDt = sdf.parse("01/02/2021");
    ...
    public static void diferencaDataJava8() {
        ...
        LocalDate data2 = LocalDate.of(2021, 2, 1);
    ...
    public static void diferencaDataJava8ComTempo() {
        LocalDateTime data1 = LocalDateTime.of(2021, 1, 1, 6, 30);
        LocalDateTime data2 = LocalDateTime.of(2021, 1, 1, 8, 30);
